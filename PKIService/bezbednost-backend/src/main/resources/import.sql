...
insert into privileges(name) values ('ADD_ENGINEER_PROJECT');
...
insert into privileges(name) values ('GET_USER');
insert into privileges(name) values ('GET_PROJECT_MANAGERS');
insert into privileges(name) values ('GET_SKILLS');
insert into privileges(name) values ('GET_SKILL');
insert into privileges(name) values ('GET_SKILLS_ENGINEER');
insert into privileges(name) values ('ADD_SKILL_ENGINEER');
insert into privileges(name) values ('UPDATE_SKILL');
insert into privileges(name) values ('DELETE_SKILL');
insert into privileges(name) values ('GET_PROJECT_WORKS');
insert into privileges(name) values ('GET_PROJECT_WORK');
insert into privileges(name) values ('GET_PROJECT_WORKS_PROJECT');
insert into privileges(name) values ('ADD_ENGINEER_PROJECT');
insert into privileges(name) values ('UPDATE_PROJECT_WORK');
insert into privileges(name) values ('DELETE_PROJECT_WORK');
insert into privileges(name) values ('CREATE_PROJECT');
insert into privileges(name) values ('UPDATE_PROJECT');
insert into privileges(name) values ('DELETE_PROJECT');
insert into privileges(name) values ('GET_CVS');
insert into privileges(name) values ('DOWNLOAD_CV');
insert into privileges(name) values ('GET_ADDRESSES');
insert into privileges(name) values ('GET_ADDRESS');
...
insert into roles_privileges(role_id, privilege_id) values (2,35);
insert into roles_privileges(role_id, privilege_id) values (2,36);
insert into roles_privileges(role_id, privilege_id) values (2,37);
insert into roles_privileges(role_id, privilege_id) values (2,39);
insert into roles_privileges(role_id, privilege_id) values (2,40);
insert into roles_privileges(role_id, privilege_id) values (2,41);
insert into roles_privileges(role_id, privilege_id) values (2,48);
insert into roles_privileges(role_id, privilege_id) values (2,49);
insert into roles_privileges(role_id, privilege_id) values (2,50);
insert into roles_privileges(role_id, privilege_id) values (2,51);
insert into roles_privileges(role_id, privilege_id) values (2,52);
insert into roles_privileges(role_id, privilege_id) values (2,53);
insert into roles_privileges(role_id, privilege_id) values (2,54);
...
insert into roles_privileges(role_id, privilege_id) values (3,39);
insert into roles_privileges(role_id, privilege_id) values (3,40);
insert into roles_privileges(role_id, privilege_id) values (3,41);
insert into roles_privileges(role_id, privilege_id) values (3,42);
insert into roles_privileges(role_id, privilege_id) values (3,43);
insert into roles_privileges(role_id, privilege_id) values (3,44);
insert into roles_privileges(role_id, privilege_id) values (3,46);
insert into roles_privileges(role_id, privilege_id) values (3,48);
insert into roles_privileges(role_id, privilege_id) values (3,49);
insert into roles_privileges(role_id, privilege_id) values (3,50);
insert into roles_privileges(role_id, privilege_id) values (3,51);
insert into roles_privileges(role_id, privilege_id) values (3,52);
insert into roles_privileges(role_id, privilege_id) values (3,53);
insert into roles_privileges(role_id, privilege_id) values (3,54);
...
insert into roles_privileges(role_id, privilege_id) values (4,39);
insert into roles_privileges(role_id, privilege_id) values (4,40);
insert into roles_privileges(role_id, privilege_id) values (4,41);
insert into roles_privileges(role_id, privilege_id) values (4,48);
insert into roles_privileges(role_id, privilege_id) values (4,49);
insert into roles_privileges(role_id, privilege_id) values (4,50);
insert into roles_privileges(role_id, privilege_id) values (4,51);
insert into roles_privileges(role_id, privilege_id) values (4,52);
insert into roles_privileges(role_id, privilege_id) values (4,53);
insert into roles_privileges(role_id, privilege_id) values (4,54);
...
insert into users(is_active, name, password, phone_number, surname, username, addressid) values (false, 'Anja', '$2a$10$s7s88elNF/TkJ9D5OyOAUejgZ/t/NsHF4/QP4JFAzzLOLjpDBLGpS', 0691442001, 'Dmitrovic', 'tibbers',1);
